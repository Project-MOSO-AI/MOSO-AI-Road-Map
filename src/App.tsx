...
function LoginPrompt({ onClose, signInWithGitHub, loading, user, isOwner }: {
  onClose: () => void; signInWithGitHub: () => Promise<void>; loading: boolean; user: boolean; isOwner: boolean;
}) {
...
function AppInner() {
  ...
  return (
    <div className="app-shell">
      ...
      {showLoginPrompt && (
        <LoginPrompt onClose={() => setShowLoginPrompt(false)} signInWithGitHub={signInWithGitHub} loading={false} user={!!user} isOwner={isOwner} />
      )}
    </div>
  );
}
